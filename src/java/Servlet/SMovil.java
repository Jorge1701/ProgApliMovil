                ...
                if (request.getParameter("nickname") == null || request.getParameter("contrasenia") == null) {
                    ...
                    if (!nickname.contains("Error")) {
                        ...
                        if (request.getParameter("recordar").equals("true")) {
                            log(request.getParameter("contrasenia"));
                            log("pass" + request.getParameter("contraseniaNoEncryptada"));
                            log("nick" + dtu.getNickname());
                            Cookie nick = new Cookie("nick", dtu.getNickname());
                            Cookie pass = new Cookie("pass", request.getParameter("contraseniaNoEncryptada"));
                            pass.setMaxAge(1 * 365 * 24 * 60 * 60);
